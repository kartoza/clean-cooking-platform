...
async function overview() {
	...
	let worldBankApiCategory = {
		'area': 'AG.LND.TOTL.K2',
		'electrification': 'EG.ELC.ACCS.ZS',
		'rural_electrification': 'EG.ELC.ACCS.RU.ZS',
		'urban_electrification': 'EG.ELC.ACCS.UR.ZS',
		'population': 'SP.POP.TOTL',
		'urban_population': 'SP.URB.TOTL.IN.ZS',
		'rural_population': 'SP.RUR.TOTL.ZS',
		'gdp_percapita': 'NY.GDP.PCAP.CD',
		'primary_intensity': 'EG.EGY.PRIM.PP.KD',
		'outages_average': 'IC.ELC.OUTG'
	}

	let nepalData = {
		'name': 'Nepal',
		'area': '143,350',
		'electrification': '93.9',
		'rural_electrification': '93.5',
		'urban_electrification': '95.75',
		'population': '28.6',
		'urban_population': '20.153',
		'rural_population': '76',
		'gdp_percapita': '1071.1',
		'primary_intensity': '7',
		'outages_average': '8.7'
	}
